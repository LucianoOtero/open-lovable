...
export default function SeguroAutoPage() {
  const handleSubmit = async (dados: DadosCotacao) => {
    try {
      ...
      console.log('Dados do seguro auto:', dados);
      ...
      <div className="bg-gradient-to-r from-brand-primary to-brand-accent text-white py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 opacity-90">
            Proteja seu veículo com a melhor cobertura do mercado
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2">Cobertura Completa</h3>
              <p className="text-sm opacity-90">
                Proteção total para seu veículo contra roubo, furto e danos
              </p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2">Assistência 24h</h3>
              <p className="text-sm opacity-90">
                Suporte completo em qualquer situação, 24 horas por dia
              </p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-2">Melhor Preço</h3>
              <p className="text-sm opacity-90">
                Cotação personalizada com os melhores preços do mercado
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white py-16">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
            Por que escolher nosso Seguro de Auto?
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">Cobertura Total</h3>
              <p className="text-gray-600 text-sm">
                Proteção completa contra roubo, furto, incêndio e danos
              </p>
            </div>
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">Assistência 24h</h3>
              <p className="text-gray-600 text-sm">
                Suporte completo em qualquer situação, a qualquer hora
              </p>
            </div>
            <div className="text-center">
      ...
      <div className="bg-brand-primary text-white py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Solicite sua cotação agora e garanta a melhor proteção para seu automóvel
          </p>
          <button 
