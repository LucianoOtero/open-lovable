...
// Componente Header Exato baseado na análise
        ...
        <div className="flex justify-between items-center py-4">
          <div className="flex items-center">
            <div className="flex-shrink-0">
              <h1 className="text-2xl font-bold text-blue-900">Seguros Imediato</h1>
            </div>
          </div>
...
// Componente Hero Exato baseado na análise
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 opacity-90 max-w-3xl mx-auto">
            Cotação Grátis e Completa Sem Compromisso
          </p>
...
// Componente Formulário Exato baseado na análise
export function ExactForm() {
...
// Componente Footer Exato baseado na análise
export function ExactFooter() {
  return (
    <footer className="bg-gray-900 text-white py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h3 className="text-xl font-bold mb-2">Seguros Imediato</h3>
          <p className="text-gray-400 mb-4">Proteção completa para você e seu patrimônio</p>
          ...
          <p className="text-gray-400 text-sm mt-4">
            © 2024 Seguros Imediato. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
...
// Componente principal que combina todos os componentes exatos
export function ExactSegurosImediato() {
  return (
